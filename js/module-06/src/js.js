...
class Hamburger {
    ...
    calculatePrice() {
        let totalCost = 0;
        const costOfToppings = this.toppings.reduce( (acc, val) => acc + Hamburger.TOPPINGS[val].price ,0 );
    ...
    calculateCalories() {
        let totalCalories = 0;
        const earnCalories = this.toppings.reduce( (acc, val) => acc + Hamburger.TOPPINGS[val].calories, 0);
