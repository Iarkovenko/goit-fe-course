  ...
  */
  ...
  _createClass(Hamburger, [{
    ...
    value: function removeTopping(topping) {
      this.toppings = this.toppings.filter(function (val) {
        return val !== topping;
      });
    }
    ...
    value: function calculatePrice() {
      var totalPrice = 0;
      var summToppingPrice = this.toppings.reduce(function (acc, cost) {
        return acc + Hamburger.TOPPINGS[cost].price;
      }, 0);
      totalPrice = Hamburger.SIZES[this.size].price + Hamburger.STUFFINGS[this.stuffing].price + summToppingPrice;
      return totalPrice;
    }
